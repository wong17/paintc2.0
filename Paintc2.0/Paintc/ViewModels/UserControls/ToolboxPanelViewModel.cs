...
namespace Paintc.ViewModels.UserControls
{
    public class ToolboxPanelViewModel : ViewModel
    {
        ...
        private readonly SourceCodeWindowViewModel sourceCodeWindowViewModel;
        ...
        public ToolboxPanelViewModel(IWindowManager windowManager, SourceCodeWindowViewModel sourceCodeWindowViewModel)
        {
            ...
            this.sourceCodeWindowViewModel = sourceCodeWindowViewModel;
        }
        ...
        private void RemoveShapeClickCommand(object? shapeName)
        {
            ...
            var result = MessageBox.Show($"Are you sure you want to remove {shapeName} from the drawing area?", "Warning", 
        ...
        private void ViewSourceCodeCommand(object? shapeName)
        {
            ...
            sourceCodeWindowViewModel.SelectedShape = DrawingHandler.Instance.GetShapeBase(shapeName.ToString());
            windowManager.ShowWindow(sourceCodeWindowViewModel, Application.Current.MainWindow);
        }
    }
}